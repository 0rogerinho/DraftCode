...
import Avatar from './userMenu/UserMenu.tsx';
...
const Header = () => {
  ...
  return (
    <header className="relative w-full flex justify-between items-center text-white bg-secondary py-4 px-[5%] md:[7.5rem] border-b border-[#2e2e2e] mb-10">
